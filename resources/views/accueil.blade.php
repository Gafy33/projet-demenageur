...
<div id="banner" class="relative bg-main w-full min-h-screen">
    <nav class="z-[1] absolute top-8 left-0 w-full flex justify-center items-center">
        <div class="w-full mx-20 rounded-full">
            ...
            <div class="float-right py-2 mx-5 flex flex-row">
                <a href="#" class="hidden lg:block relative text-xs text-white py-2 uppercase group">
                    équipes
                    <div class="absolute left-0 top-full w-0 h-0.5 bg-white rounded-full group-hover:w-full duration-300 ease-in-out"></div>
                </a>
                <a href="#" class="hidden lg:block relative text-xs text-white py-2 ml-6 uppercase group">
                    En savoir plus
                    <div class="absolute left-0 top-full w-0 h-0.5 bg-white rounded-full group-hover:w-full duration-300 ease-in-out"></div>
                </a>
    ...
    <div class="absolute top-0 left-0 w-full h-full flex flex-col lg:flex-row">
        <div class="w-full lg:w-1/2 h-full flex flex-col justify-center text-white pl-16 pr-16 lg:pl-24 lg:pr-0">
        ...
        <div class="w-full lg:w-1/2 h-full flex justify-center items-center">
            @if( $iframe == "ok" )
                <iframe class="w-full h-full mt-0 lg:mt-32 xl:mt-16" src="{{asset('assets/iframes/iframe_piece.html')}}"></iframe>
            @endif
        </div>
    </div>
...
<div class="relative w-full flex flex-col bg-gris">
    <div id="scan__" class="w-full flex flex-col lg:flex-row">
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center py-32 lg:py-0 lg:min-h-screen">
            <div class="cube">
                <div class="top"></div>
                <div>
                    <span style="--i:0;"></span>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center lg:min-h-screen px-24 py-16 lg:py-0">
    ...
    <div id="visualisation__" class="w-full hidden lg:flex flex-col lg:flex-row">
        <div class="w-full lg:w-1/2 flex flex-col justify-center lg:min-h-screen px-24 py-16 lg:py-0">
            <div class="px-2 py-4 flex flex-row">
    ...
    <div id="visualisation__" class="w-full lg:hidden flex flex-col lg:flex-row">
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center py-32 lg:py-0 lg:min-h-screen">
            <div class="cube">
                <div class="top"></div>
                <div>
    ...
    <div id="deplacement__" class="w-full flex flex-col lg:flex-row">
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center py-32 lg:py-0 lg:min-h-screen">
            <div class="cube">
                <div class="top"></div>
                <div>
    ...
    <div class="flex flex-row">
        <div class="w-1/3 flex justify-center items-center h-64">
            <div id="box_qui" class="group relative flex flex-col justify-center items-center border-2 border-violet rounded-lg px-16 py-8">
                ...
                <img class="w-20 h-20 lg:w-32 lg:h-32 group-hover:invert z-[1]" src="{{asset('assets/images/people.png')}}"/>
        ...
        <div class="w-1/3 flex justify-center items-center h-64">
            <div id="box_qui" class="group relative flex flex-col justify-center items-center border-2 border-violet rounded-lg px-16 py-8">
                <div class="absolute left-0 top-0 rounded-lg border w-full h-0 bg-black z-[0] invisible opacity-0 group-hover:h-full group-hover:visible group-hover:opacity-100 duration-300 ease-in-out"></div>
                <img class="w-20 h-20 lg:w-32 lg:h-32 group-hover:invert z-[1]" src="{{asset('assets/images/office-building.png')}}"/>
        ...
        <div class="w-1/3 flex justify-center items-center h-64">
            <div id="box_qui" class="group relative flex flex-col justify-center items-center border-2 border-violet rounded-lg px-16 py-8">
                <div class="absolute left-0 top-0 rounded-lg border w-full h-0 bg-black z-[0] invisible opacity-0 group-hover:h-full group-hover:visible group-hover:opacity-100 duration-300 ease-in-out"></div>
                <img class="w-20 h-20 lg:w-32 lg:h-32 group-hover:invert z-[1]" src="{{asset('assets/images/mover-truck.png')}}"/>
...
<div id="roadmap" class="relative bg-gris w-full pb-32">
    ...
    <div class="w-full flex flex-col text-white">
        <div class="flex flex-row justify-center items-center mt-16">
            <div class="w-5/12 h-28 flex flex-row justify-end items-center">
                <div id="roadmap_right_1" class="w-5/5 lg:w-4/5 xl:w-3/5 px-6 py-4 border-2 border-white text-white rounded-xl text-lg">
        ...
        <div class="flex flex-row justify-center items-center mt-16">
            ...
            <div class="w-5/12 h-28 flex flex-row justify-start items-center">
                <div id="roadmap_left_2" class="w-5/5 lg:w-4/5 xl:w-3/5 px-6 py-4 border-2 border-white text-white rounded-xl text-lg">
                    Adventure Coast Punks will only be sold on Solsea. For a fair distribution, multiple sale rounds will be held for the NFT participants.
                </div>
            </div>
        </div>
        <div class="flex flex-row justify-center items-center mt-16">
            <div class="w-5/12 h-28 flex flex-row justify-end items-center">
                <div id="roadmap_right_3" class="w-5/5 lg:w-4/5 xl:w-3/5 px-6 py-4 border-2 border-white text-white rounded-xl text-lg">
                    Adventure Coast Punks will only be sold on Solsea. For a fair distribution, multiple sale rounds will be held for the NFT participants.
                </div>
            </div>
            <div class="w-1/12 h-28 flex flex-row justify-center items-center">
        ...
        <div class="flex flex-row justify-center items-center mt-16">
            ...
            <div class="w-5/12 h-28 flex flex-row justify-start items-center">
                <div id="roadmap_left_4" class="w-5/5 lg:w-4/5 xl:w-3/5 px-6 py-4 border-2 border-white text-white rounded-xl text-lg">
                    Adventure Coast Punks will only be sold on Solsea. For a fair distribution, multiple sale rounds will be held for the NFT participants.
                </div>
            </div>
        </div>
        <div class="flex flex-row justify-center items-center mt-16">
            <div class="w-5/12 h-28 flex flex-row justify-end items-center">
                <div id="roadmap_right_5" class="w-5/5 lg:w-4/5 xl:w-3/5 px-6 py-4 border-2 border-white text-white rounded-xl text-lg">
                    Adventure Coast Punks will only be sold on Solsea. For a fair distribution, multiple sale rounds will be held for the NFT participants.
                </div>
            </div>
            <div class="w-1/12 h-28 flex flex-row justify-center items-center">
    ...
    <div class="absolute left-0 top-0 w-full h-full flex justify-center items-center">
        <div class="w-0.5 h-[60%] mt-24 lg:mt-40 bg-white"></div>
    </div>
...
<div class="relative bg-main w-full pb-16">
    ...
    <div class="flex flex-row justify-center items-center">
        <div class="w-3/12 lg:w-2/12 p-6 flex flex-col justify-center items-center">
            <img class="w-20 h-20 lg:w-32 lg:h-32" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Laravel.svg/1200px-Laravel.svg.png"/>
            <div class="text-xl xl:text-2xl text-white mt-6">Laravel</div>
        </div>
        <div class="w-3/12 lg:w-2/12 p-6 flex flex-col justify-center items-center">
            <img class="w-20 h-20 lg:w-32 lg:h-32" src="https://github.com/symfony.png"/>
            <div class="text-xl xl:text-2xl text-white mt-6">symfony</div>
        </div>
        <div class="w-3/12 lg:w-2/12 p-6 flex flex-col justify-center items-center">
            <img class="w-20 h-20 lg:w-32 lg:h-32" src="https://aws1.discourse-cdn.com/standard17/uploads/threejs/original/2X/e/e4f86d2200d2d35c30f7b1494e96b9595ebc2751.png"/>
            <div class="text-xl xl:text-2xl text-white mt-6">ThreeJS</div>
        </div>
        <div class="w-3/12 lg:w-2/12 p-6 flex flex-col justify-center items-center">
            <img class="w-24 h-20 lg:w-36 lg:h-32" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/539px-React-icon.svg.png"/>
...
<div class="relative bg-gris w-full lg:min-h-screen pb-8 lg:pb-16 2xl:pb-0">
    <div class="w-full py-16 flex justify-center items-center text-4xl xl:text-7xl z-[1] text-white">
         Question Fréquente
    </div>
    <div class="flex flex-col justify-center items-center px-16 lg:px-32 xl:px-48 2xl:px-64 cursor-default">
